...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setDockOptions(QtWidgets.QMainWindow.ForceTabbedDocks)
        ...
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.tab_scanner)
        ...
        self.horizontalLayout_header.setSizeConstraint(QtWidgets.QLayout.SetMaximumSize)
        self.horizontalLayout_header.setObjectName(_fromUtf8("horizontalLayout_header"))
        self.label_cur_channel = QtWidgets.QLabel(self.tab_scanner)
        ...
        self.pushButton_apply = QtWidgets.QPushButton(self.tab_scanner)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.treeWidget = QtWidgets.QTreeWidget(self.tab_scanner)
        ...
        self.horizontalLayout_scanner = QtWidgets.QHBoxLayout()
        self.horizontalLayout_scanner.setSpacing(10)
        self.horizontalLayout_scanner.setContentsMargins(10,10,10,10)
        self.horizontalLayout_scanner.setObjectName(_fromUtf8("horizontalLayout_scanner"))
        self.pushButton_scan_start = QtWidgets.QPushButton(self.tab_scanner)
        ...
        self.pushButton_scan_stop = QtWidgets.QPushButton(self.tab_scanner)
        ...
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(self.tab_sniffer)
        self.horizontalLayout_6.setObjectName(_fromUtf8("horizontalLayout_6"))
        self.horizontalLayout_sniffer = QtWidgets.QHBoxLayout()
        ...
        self.label_enc = QtWidgets.QLabel(self.gb_setting)
        self.label_enc.setObjectName(_fromUtf8("label_enc"))
        self.horizontalLayout_enc.addWidget(self.label_enc)
        self.comboBox_enc = QtWidgets.QComboBox(self.gb_setting)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_key = QtWidgets.QLabel(self.gb_setting)
        self.label_key.setObjectName(_fromUtf8("label_key"))
        self.horizontalLayout_key.addWidget(self.label_key)
        self.lineEdit_key = QtWidgets.QLineEdit(self.gb_setting)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_hex = QtWidgets.QHBoxLayout()
        ...
        self.checkBox_hex = QtWidgets.QCheckBox(self.gb_setting)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_key.sizePolicy().hasHeightForWidth())
        ...
        self.gb_options = QtWidgets.QGroupBox(self.frame_sniffer)
        ...
        self.pushButton_sniff_start = QtWidgets.QPushButton(self.frame_sniffer)
        ...
        self.pushButton_sniff_stop = QtWidgets.QPushButton(self.frame_sniffer)
        ...
        self.gb_log = QtWidgets.QGroupBox(self.tab_sniffer)
        ...
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.gb_log)
        self.verticalLayout_6.setSpacing(9)
        self.verticalLayout_6.setContentsMargins(0, 20, 20, 20)
        self.verticalLayout_6.setObjectName(_fromUtf8("verticalLayout_6"))
        self.textEdit_log = QtWidgets.QTextEdit(self.gb_log)
        ...
        self.pushButton_clear = QtWidgets.QPushButton(self.gb_log)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def __eventSetting(self):
        self.pushButton_clear.clicked.connect(self.textEdit_log.clear)
        self.pushButton_scan_start.clicked.connect(self.__h_scan_start)
        self.pushButton_scan_stop.clicked.connect(self.__h_scan_stop)
        self.pushButton_apply.clicked.connect(self.__h_apply)
        self.pushButton_sniff_start.clicked.connect(self.__h_sniff_start)
        self.pushButton_sniff_stop.clicked.connect(self.__h_sniff_stop)
...
class Interface_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.listWidget.currentItemChanged.connect(self.__setInterface)
...
class MainProc:
    ...
    def __wlan_popup(self):
        self.ui.Dialog = QtWidgets.QDialog()
        ui = Interface_Dialog()
